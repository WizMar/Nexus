...
import { usePreferences, LANGUAGES, DATE_FORMATS } from '@/context/PreferencesContext'
...
const ROLE_COLORS: Record<string, string> = {
  ...
  Employee:    'bg-stone-600/20 text-stone-400',
  Laborer:     'bg-stone-700/20 text-stone-500',
}
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 text-white">
      <div>
        ...
        <p className="text-stone-400 text-sm mt-1">Personal preferences and account settings.</p>
      </div>
      ...
      <Card className="bg-stone-900 border-stone-800">
        <CardHeader className="pb-3">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-emerald-600/20 border border-emerald-600/40 flex items-center justify-center">
            ...
            <span className={`ml-auto text-xs font-medium px-2.5 py-1 rounded-full ${ROLE_COLORS[user?.role ?? ''] ?? 'bg-stone-800 text-stone-400'}`}>
              {user?.role}
            </span>
          </div>
        </CardHeader>
      ...
      <Card className="bg-stone-900 border-stone-800">
        <CardHeader>
          ...
          <CardDescription className="text-stone-400">Set your preferred language and date/time display.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-stone-300 text-sm font-medium">Language</label>
            ...
            <div className="space-y-2">
              <label className="text-stone-300 text-sm font-medium">Date Format</label>
            ...
            <div className="space-y-2">
              <label className="text-stone-300 text-sm font-medium">Time Format</label>
            ...
            <div className="space-y-2">
              <label className="text-stone-300 text-sm font-medium">First Day of Week</label>
      ...
      <Card className="bg-stone-900 border-stone-800">
        <CardHeader>
          ...
          <CardDescription className="text-stone-400">Control how the app looks for you.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-1">
          <div className="flex items-center justify-between py-3 border-b border-stone-800">
            <div>
              ...
              <p className="text-stone-500 text-xs mt-0.5">Use dark theme across the app.</p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between py-3">
            <div>
              ...
              <p className="text-stone-500 text-xs mt-0.5">Coming soon — light theme is in progress.</p>
            </div>
            <span className="text-xs text-stone-500 bg-stone-800 px-2 py-1 rounded-full">Soon</span>
          </div>
        </CardContent>
      </Card>
